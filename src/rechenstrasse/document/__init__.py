...
internal representation of record 0005 is issue #25 and is in `reader.py`, with
`positions.py` beside it holding the one thing a refusal needs that a path
cannot give: the line and the column the refusal is about.
"""
